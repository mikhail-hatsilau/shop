    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_date', models.DateTimeField(default=datetime.datetime(2016, 1, 6, 10, 53, 58, 633275, tzinfo=utc))),
                ('to_date', models.DateTimeField(default=datetime.datetime(2016, 1, 13, 10, 53, 58, 633313, tzinfo=utc))),
